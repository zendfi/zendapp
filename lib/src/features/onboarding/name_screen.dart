...
class _NameScreenState extends State<NameScreen> {
  ...
  void initState() {
    ...
    // Uses ZendScope.read, not .of — this is a one-shot read with no
    // rebuild dependency, and .of() throws in debug builds when called
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    if (waitlistMatched) ...[
                      ...
                      Text("What's your name?", style: TextStyle(fontFamily: 'Geist', fontSize: 28, fontWeight: FontWeight.w700, color: zt.textPrimary)),
