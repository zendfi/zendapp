    ...
    return Column(
      ...
      children: [
        ...
        if (!customMode) ...[
          ...
          if (amountError != null)
            Padding(
              ...
              child: Text(amountError!, style: const TextStyle(fontFamily: 'Satoshi', fontSize: 11, color: ZendColors.destructive)),
            ),
        ...
        ElevatedButton(
          ...
          child: Text(
            'Choose a sticker',
            style: const TextStyle(fontFamily: 'Satoshi', fontSize: 15, fontWeight: FontWeight.w700),
          ),
        ),
      ],
    );
    ...
    return Column(
      ...
      children: [
        ...
        ElevatedButton(
          ...
          child: const Text('Preview', style: TextStyle(fontFamily: 'Satoshi', fontSize: 15, fontWeight: FontWeight.w700)),
        ),
      ],
    );
  }
