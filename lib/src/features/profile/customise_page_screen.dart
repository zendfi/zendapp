                ...
                child: ZendScrollPage(
                    child: Column(
                      ...
                      children: [
                        ...
                        _Card(zt: zt, child: Row(
                          children: [
                            Expanded(child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Text('Show recent activity', style: TextStyle(fontFamily: 'Satoshi', fontSize: 15, fontWeight: FontWeight.w500, color: zt.textPrimary)),
                                const SizedBox(height: 2),
                                Text('Display recent payment count on your page', style: TextStyle(fontFamily: 'Satoshi', fontSize: 12, color: zt.textSecondary)),
                              ],
                            )),
                            Switch.adaptive(
                        ...
                        if (_error != null) ...[
                          const SizedBox(height: 16),
                          Text(_error!, style: const TextStyle(fontFamily: 'Satoshi', fontSize: 13, color: ZendColors.destructive)),
                        ],
        ...
        Container(
          ...
          child: switch (_linkStyle) {
            'minimal' => Row(children: [
                CircleAvatar(radius: 20, backgroundColor: themeColor, child: Text(displayName.isNotEmpty ? displayName[0].toUpperCase() : 'Z', style: const TextStyle(color: Colors.white, fontFamily: 'Satoshi', fontWeight: FontWeight.w700, fontSize: 18))),
        ...
        return Expanded(
          child: GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              child: Column(children: [
                Text(label, style: TextStyle(fontFamily: 'Satoshi', fontSize: 13, fontWeight: FontWeight.w600, color: isSelected ? themeColor : zt.textPrimary)),
                const SizedBox(height: 2),
                Text(desc, textAlign: TextAlign.center, style: TextStyle(fontFamily: 'Satoshi', fontSize: 10, color: zt.textSecondary)),
              ]),
            ),
          ),
        );
